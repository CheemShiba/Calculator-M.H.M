...
res_label = Label(root, width=50, height=5, text="", font=("Arial", 20), bg="white")
...
Button(root, text="x", width=5, height=1, font=("Arial", 30, "bold"), bd=1, fg="dim gray", bg="gray12", command=lambda: show("x")).place(x=430, y=100)
...
Button(root, text="=", width=5, height=3, font=("Arial", 30, "bold"), bd=1, fg="dim gray", bg="orange", command=lambda: show("=")).place(x=430, y=400)
